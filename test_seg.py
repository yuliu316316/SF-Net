...
def init_args():
    ...
    parser.add_argument('--train', type=bool, help='make prediction on training data', default=False) #False True
    ...
    parser.add_argument('-i', '--image_shape', type=int,  nargs='+', help='The shape of input tensor;'
                        ...
                        default=[128, 192, 160])#[128, 192, 160]v
...
label_list = [None, "WT"]   # None represents using all 3 labels  , "TC", "ET"
...
config["num_labels"] = 3 #if config["seg_label"] else 3      # used for model constructing
...
#        if patient_filename in LGG_list:
#            preds_array[preds_array == 4] = 1
